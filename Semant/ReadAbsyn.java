...
//Program(AbstractList<ClassDecl> classes)
  static final public Semant.Absyn.Program Program() throws ParseException {
    ...
    jj_consume_token(7);
    jj_consume_token(0);
      {if (true) return new Semant.Absyn.Program(cl,ctl);}
    throw new Error("Missing return statement in function");
  }

//ClassDecl(String name, String parent, LinkedList<VarDecl> fields, LinkedList<MethodDecl> methods)
  static final public void ClassDecl(LinkedList<Semant.Absyn.ClassDecl> cl,LinkedList<Semant.Types.CLASS>ctl) throws ParseException {
  ...
  static final public Semant.Types.CLASS CLASS() throws ParseException {
        Token name = null, parent = null;
  ...
  static final public Semant.Types.RECORD RECORD() throws ParseException {
  ...
  static final public void FIELD(LinkedList<Semant.Types.FIELD> fl) throws ParseException {
...
//ThreadDecl(String name, LinkedList<VarDecl> fields, LinkedList<MethodDecl> methods)
  static final public void ThreadDecl(LinkedList<Semant.Absyn.ClassDecl> cl,LinkedList<Semant.Types.CLASS>ctl) throws ParseException {
        Token name = null;
        LinkedList<Semant.Absyn.VarDecl> vl = new LinkedList<Semant.Absyn.VarDecl>();
        LinkedList<Semant.Absyn.MethodDecl> ml = new LinkedList<Semant.Absyn.MethodDecl>();
        Semant.Types.CLASS c;
...
//		      Expr returnVal)
  static final public void MethodDecl(LinkedList<Semant.Absyn.MethodDecl> ml) throws ParseException {
...
//		      LinkedList<VarDecl> locals,
//		      LinkedList<Stmt> stmts)
  static final public void VoidDecl(LinkedList<Semant.Absyn.MethodDecl> ml) throws ParseException {
        Token name;
        Semant.Absyn.Stmt    stmt  = null;
        LinkedList<Semant.Absyn.VarDecl> locals  = new LinkedList<Semant.Absyn.VarDecl>();
        LinkedList<Semant.Absyn.Stmt> stmts      = new LinkedList<Semant.Absyn.Stmt>();
...
//Formal(Type type, String name)
  static final public Semant.Absyn.Formal Formal() throws ParseException {
...
//VarDecl(Type type, String name, Expr init)
  static final public void VarDecl(LinkedList<Semant.Absyn.VarDecl> vl) throws ParseException {
        Semant.Absyn.Type type;
        Token name;
  ...
  static final public Semant.Types.Type typeTYPE() throws ParseException {
        Semant.Types.Type t;
  ...
  static final public Semant.Types.Type FUNCTION() throws ParseException {
    ...
    result = typeTYPE();
    jj_consume_token(7);
                {if (true) return new Semant.Types.FUNCTION(Symbol.symbol(name.image),self,r,result);}
    throw new Error("Missing return statement in function");
  }

  static final public Semant.Types.Type ARRAY() throws ParseException {
  Semant.Types.Type t = null;
    jj_consume_token(63);
    jj_consume_token(6);
    t = typeTYPE();
    jj_consume_token(7);
          {if (true) return new Semant.Types.ARRAY(t);}
    throw new Error("Missing return statement in function");
  }

  static final public Semant.Types.Type BOOLEAN() throws ParseException {
    jj_consume_token(66);
          {if (true) return new Semant.Types.BOOLEAN();}
    throw new Error("Missing return statement in function");
  }

  static final public Semant.Types.Type INT() throws ParseException {
    jj_consume_token(60);
          {if (true) return new Semant.Types.INT();}
    throw new Error("Missing return statement in function");
  }

  static final public Semant.Types.Type OBJECT() throws ParseException {
  Semant.Types.CLASS t;
    jj_consume_token(65);
    jj_consume_token(6);
    t = getClassName();
    jj_consume_token(7);
          {if (true) return new Semant.Types.OBJECT(t);}
    throw new Error("Missing return statement in function");
  }

  static final public Semant.Types.CLASS getClassName() throws ParseException {
        Semant.Symbol.Symbol s;
        Token n;
    n = jj_consume_token(ID);
          {if (true) return new Semant.Types.CLASS(new Semant.Symbol.Symbol(n.image));}
    throw new Error("Missing return statement in function");
  }

  static final public Semant.Absyn.Type Type() throws ParseException {
 Semant.Absyn.Type t;
...
// ArrayType(Type base)
  static final public Semant.Absyn.Type ArrayType() throws ParseException {
  Semant.Absyn.Type t;
    jj_consume_token(12);
    jj_consume_token(6);
    t = Type();
...
// BooleanType() { }
  static final public Semant.Absyn.Type BooleanType() throws ParseException {
    jj_consume_token(17);
...
// IntegerType() { }
  static final public Semant.Absyn.Type IntegerType() throws ParseException {
    jj_consume_token(31);
...
// IdentifierType(String id)
  static final public Semant.Absyn.Type IdentifierType() throws ParseException {
  Token t;
    jj_consume_token(28);
    jj_consume_token(6);
  ...
  static final public Semant.Absyn.Stmt Stmt() throws ParseException {
        Semant.Absyn.Stmt s;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 14:
      s = AssignStmt();
...
//AssignStmt(AssignableExpr lhs, Expr rhs)
  static final public Semant.Absyn.Stmt AssignStmt() throws ParseException {
...
//BlockStmt(LinkedList<Stmt> stmts)
  static final public Semant.Absyn.Stmt BlockStmt() throws ParseException {
        Semant.Absyn.Stmt stmt = null;
        LinkedList<Semant.Absyn.Stmt> stmts      = new LinkedList<Semant.Absyn.Stmt>();
    jj_consume_token(16);
    jj_consume_token(6);
...
//IfStmt(Expr test, Stmt thenStm, Stmt elseStm)
  static final public Semant.Absyn.Stmt IfStmt() throws ParseException {
...
//XinuCallStmt(list of Expr)
  static final public Semant.Absyn.Stmt XinuCallStmt() throws ParseException {
        Token name;
...
//WhileStmt(Expr test, Stmt body)
  static final public Semant.Absyn.Stmt WhileStmt() throws ParseException {
        Semant.Absyn.Expr test;
  ...
  static final public Semant.Absyn.Expr Expr() throws ParseException {
        Semant.Absyn.Expr e;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 9:
      e = AddExpr();
...
//AddExpr(Expr e1, Expr e2)
  static final public Semant.Absyn.AddExpr AddExpr() throws ParseException {
...
//AndExpr(Expr e1, Expr e2)
  static final public Semant.Absyn.AndExpr AndExpr() throws ParseException {
        Semant.Absyn.Expr e1, e2;
    jj_consume_token(10);
    jj_consume_token(6);
    e1 = Expr();
...
//DivExpr(Expr e1, Expr e2)
  static final public Semant.Absyn.DivExpr DivExpr() throws ParseException {
        Semant.Absyn.Expr e1, e2;
    jj_consume_token(20);
    jj_consume_token(6);
    e1 = Expr();
...
//EqualExpr(Expr e1, Expr e2)
  static final public Semant.Absyn.EqualExpr EqualExpr() throws ParseException {
        Semant.Absyn.Expr e1, e2;
    jj_consume_token(21);
    jj_consume_token(6);
    e1 = Expr();
...
//GreaterExpr(Expr e1, Expr e2)
  static final public Semant.Absyn.GreaterExpr GreaterExpr() throws ParseException {
        Semant.Absyn.Expr e1, e2;
    jj_consume_token(26);
    jj_consume_token(6);
    e1 = Expr();
...
//LesserExpr(Expr e1, Expr e2)
  static final public Semant.Absyn.LesserExpr LesserExpr() throws ParseException {
        Semant.Absyn.Expr e1, e2;
    jj_consume_token(32);
    jj_consume_token(6);
    e1 = Expr();
...
//MulExpr(Expr e1, Expr e2)
  static final public Semant.Absyn.MulExpr MulExpr() throws ParseException {
        Semant.Absyn.Expr e1, e2;
    jj_consume_token(34);
    jj_consume_token(6);
    e1 = Expr();
...
//NotEqExpr(Expr e1, Expr e2)
  static final public Semant.Absyn.NotEqExpr NotEqExpr() throws ParseException {
        Semant.Absyn.Expr e1, e2;
    jj_consume_token(38);
    jj_consume_token(6);
    e1 = Expr();
...
//OrExpr(Expr e1, Expr e2)
  static final public Semant.Absyn.OrExpr OrExpr() throws ParseException {
        Semant.Absyn.Expr e1, e2;
    jj_consume_token(41);
    jj_consume_token(6);
    e1 = Expr();
...
//SubExpr(Expr e1, Expr e2)
  static final public Semant.Absyn.SubExpr SubExpr() throws ParseException {
        Semant.Absyn.Expr e1, e2;
    jj_consume_token(45);
    jj_consume_token(6);
    e1 = Expr();
...
//ArrayExpr(Expr target, Expr index)
  static final public Semant.Absyn.ArrayExpr ArrayExpr() throws ParseException {
...
//CallExpr(Expr target, String method, LinkedList<Expr> args)
  static final public Semant.Absyn.CallExpr CallExpr() throws ParseException {
...
//FalseExpr()
  static final public Semant.Absyn.FalseExpr FalseExpr() throws ParseException {
    jj_consume_token(23);
...
//FieldExpr(Expr target, String field)
  static final public Semant.Absyn.FieldExpr FieldExpr() throws ParseException {
        Semant.Absyn.Expr target;
        Token field;
    jj_consume_token(24);
    jj_consume_token(6);
...
//IdentifierExpr(String id)
  static final public Semant.Absyn.IdentifierExpr IdentifierExpr() throws ParseException {
        Token id;
    jj_consume_token(27);
    jj_consume_token(6);
...
//NegExpr(Expr e1)
  static final public Semant.Absyn.NegExpr NegExpr() throws ParseException {
...
//NewArrayExpr(Type type, LinkedList<Expr> dimensions)
  static final public Semant.Absyn.NewArrayExpr NewArrayExpr() throws ParseException {
        Semant.Absyn.Type type;
...
//NewObjectExpr(Type type)
  static final public Semant.Absyn.NewObjectExpr NewObjectExpr() throws ParseException {
        Semant.Absyn.Type type;
    jj_consume_token(37);
    jj_consume_token(6);
    type = Type();
...
//NotExpr(Expr e1)
  static final public Semant.Absyn.NotExpr NotExpr() throws ParseException {
        Semant.Absyn.Expr e1;
    jj_consume_token(39);
    jj_consume_token(6);
    e1 = Expr();
...
//NullExpr()
  static final public Semant.Absyn.NullExpr NullExpr() throws ParseException {
    jj_consume_token(40);
...
//XinuCallExpr(list of Expr)
  static final public Semant.Absyn.XinuCallExpr XinuCallExpr() throws ParseException {
        Token name;
        Semant.Absyn.Expr arg;
        LinkedList<Semant.Absyn.Expr> args      = new LinkedList<Semant.Absyn.Expr>();
    jj_consume_token(53);
...
//ThisExpr()
  static final public Semant.Absyn.ThisExpr ThisExpr() throws ParseException {
    jj_consume_token(46);
...
//TrueExpr()
  static final public Semant.Absyn.TrueExpr TrueExpr() throws ParseException {
    jj_consume_token(48);
...
//IntegerLiteral(int value)
  static final public Semant.Absyn.IntegerLiteral IntegerLiteral() throws ParseException {
  Token t;
    jj_consume_token(30);
    jj_consume_token(6);
...
//StringLiteral(String value)
  static final public Semant.Absyn.StringLiteral StringLiteral() throws ParseException {
  Token t;
    jj_consume_token(44);
    jj_consume_token(6);
  ...
  static public ReadAbsynTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80000,0x80000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x90021000,0x0,0x2000000,0x0,0x20014000,0x0,0x20014000,0x4db40e00,0x20014000,0x20014000,0x20014000,0x4db40e00,0x4db40e00,0x4db40e00,0x4db40e00,0x4db40e00,0x4db40e00,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x8000,0x8000,0x8000000,0x40000,0x2,0x20000000,0x40000,0x80002,0x80002,0x800000,0x2000000,0x0,0x40000,0x500000,0x40000,0x500000,0x82173fd,0x500000,0x500000,0x8500000,0x2173fd,0x2173fd,0x2173fd,0x82173fd,0x82173fd,0x2173fd,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x8000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
